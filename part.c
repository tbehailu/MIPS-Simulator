...
void execute_instruction(Instruction instruction,Processor* processor,Byte *memory) {
    ...
    switch(instruction.opcode) {
            ...
            switch(instruction.rtype.funct) {
                ...
                case 0x9: // funct == 0x09 (JALR)
                    ...
                    */
                    ...
                    temp1 = processor->PC + 4;
                    processor->PC = processor->R[instruction.rtype.rs];
                    processor->R[instruction.rtype.rd] = temp1;
                ...
                case 0x18: { // funct == 0x18 (MULT)
                    ...
                    */
                    ...
                    temp1 = (((sDouble) processor->R[instruction.rtype.rs]) *  (sDouble) processor->R[instruction.rtype.rt]);
                  
                    processor->RLO = (Word) temp1;
                    processor->RHI = (Word) (temp1 >> 32);
                    processor->PC += 4;
                ...
                case 0x19: // funct == 0x19 (MULTU)
                    ...
                    */
                    ...
                    temp1 = (((Double) processor->R[instruction.rtype.rs]) * (Double) processor->R[instruction.rtype.rt]);
        ...
        case 0x20: // opcode == 0x20 (LB) 
            ...
            temp2 = processor->R[instruction.itype.rs] + ((sWord) ((sHalf) instruction.itype.imm));
            processor->R[instruction.itype.rt] = (sWord) load(memory, temp2, LENGTH_BYTE);
            processor->PC += 4;
            break;
        case 0x21: // opcode == 0x21 (LH)
            ...
            processor->R[instruction.itype.rt] = (sWord) load(memory, temp2, LENGTH_HALF_WORD);
            processor->PC += 4;
            break;
        case 0x23: // opcode == 0x23 (LW)
            ...
            processor->R[instruction.itype.rt] = load(memory, temp2, LENGTH_WORD);
        ...
        case 0x24: // opcode == 0x24 (LBU)
            ...
            temp2 = processor->R[instruction.itype.rs] + ((sWord) ((sHalf) instruction.itype.imm));
            processor->R[instruction.itype.rt] = (Word) load(memory, temp2, LENGTH_BYTE);
            processor->PC += 4;
            break;
        ...
        case 0x25: // opcode == 0x25 (LHU) 
            ...
            temp2 = processor->R[instruction.itype.rs] + ((sWord) ((sHalf) instruction.itype.imm));
            processor->R[instruction.itype.rt] = (Word) load(memory, temp2, LENGTH_HALF_WORD);
            processor->PC += 4;
            break;
